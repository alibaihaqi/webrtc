<template>
  <div class="flex items-center justify-center p-4 bg-gray-800 space-x-4">
    <button
    ...
    >
      <svg v-if="!isVideoOff" class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
