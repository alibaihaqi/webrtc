...
.device-toggle {
  @apply p-2 rounded-full bg-gray-700 hover:bg-gray-600 text-white transition-colors;
}

.device-dropdown {
  @apply absolute bottom-full right-0 mb-2 w-64 bg-gray-800 rounded-lg shadow-lg p-3;
}
...
.device-select {
  @apply w-full bg-gray-700 text-white rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500;
}
</style>
